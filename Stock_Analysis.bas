...
Sub Stock_Analysis()
    ...
    'Loop through the worksheets in the workbook containing the Stock Information

    'Create a variable to control how many times we cycle through the worksheets
    ...
    For Each ws In Worksheets
        ...
        'Initialize variable to hold the ticker symbol
        ...
        'Initialize variable to hold year open price
        ...
        'Initialize variable to hold year close price
        ...
        'Initialize variable to hold the change in price for the year
        ...
        'Initialize variable to hold the percent change in price for the year
        ...
        'Initialize variable to hold total volume of stock traded
        ...
        'Initialize variable for total rows to loop through
        ...
        For i = 2 To lastrow
            ...
            'If a new year is encountered get the year open price
            ...
            'Check to determine if the ticker symbol changed
            ...
            If ws.Cells(i, 1).Value <> ws.Cells(i + 1, 1).Value Then
                ...
                'Check for new year to format to highlight positive or negative change.
                ...
                'Check to see if we need to calculate percent change

                If year_open = 0 And year_close = 0 Then

                    'Be sure we aren't dividing by zero if the start and end price are zero
